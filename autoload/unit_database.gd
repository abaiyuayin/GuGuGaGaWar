...
## S2 仓鼠士兵 / S3 天命人（原天明人）/ Y2 凑企鹅 / Y3 香蕉猫 / Y4 我的刀盾 / S4 动力菲子 / S5 咕嘎工钢 / S6 小猫臭臭舞（仅过场加载动画）
## S7 大肥鱼 / S8 丽贝卡（特殊阵营，四套与三套动画，可战斗，开发工具可召唤）
## S9 萌黄（2026-09-19 从直播版搬入）：特殊阵营远程兵种，攻击无弹道、命中帧在目标身上播特效
const HIDDEN_UNITS: Array[String] = ["S2", "S3", "Y2", "Y3", "Y4", "S4", "S5", "S6", "S7", "S8", "S9"]
